	...
	<div class="col-md-4 border border-5 border-dark">
		...
		<form method="POST" >
			...
			<div class="btn-group ml-auto" style="margin: 10px 10px 10px 0px">
				<button class="btn btn-sm btn-primary" type="submit" formaction="/showMailTxt">
				送信予定メール内容を確認
				</button>
				<button class="btn btn-sm btn-primary" style="margin-left:10px" type="submit" formaction="/addMediator">
				上記内容を登録
				</button>
			</div>
		</form>
